...
function renderBattle(){
  // Tabuleiro inimigo: os navios ficam escondidos até serem atingidos.
  renderBoard($("enemyBoard"), enemy.ships, true, [], true);

  // Sua frota: seus navios continuam visíveis.
  renderBoard($("playerBoard"), player.ships, false, [], false);
}
